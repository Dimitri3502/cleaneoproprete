...
// Set the bucket ACL
const bucketAcl = new scaleway.object.BucketAcl(
  'site-bucket-acl',
  {
    bucket: bucket.name,
    acl: 'public-read',
...
const bucketWebsite = new scaleway.object.BucketWebsiteConfiguration(
  'site-website',
  {
    bucket: bucket.name,
    indexDocument: {
...
const siteDir = path.join(__dirname, '..', 'apps', 'nextjs-front', 'out');
